...
parser.add_argument('--model', default='cmslstm', help='model name')
parser.add_argument('--optimizer', default='adamw', help='optimizer to train with')
...
parser.add_argument('--dataset', default='mmnist',
                    help='dataset to train with | mmnist, taxibj')
